...
namespace CNC_Assist
{
    ...
    public class SettingController
    {
        ...
        /// Минимальный объем буфера контроллера, при котором посылаем данные
        /// </summary>
        [DisplayName(@"Минимальный размер свободного буфера")]
        [Description("Данный параметр означает сколько оставлять не занятыми/пустыми ячейки в буфере контроллера. (для МК1 значение не должно быть выше 14, и для МК2 -250)")]
        [PropertyOrder(5)]
        ...
        /// Использование концевика
        /// </summary>
        private bool _UseLimitSwichXmax = true;
        /// <summary>
        /// Использование концевика
        /// </summary>
        [DisplayName(@"X+")]
        ...
        [TypeConverter(typeof(BooleanTypeConverter))]
        public bool UseLimitSwichXmax
        {
            get { return _UseLimitSwichXmax; }
            set { _UseLimitSwichXmax = value; }
        }
        ...
        /// Использование концевика
        /// </summary>
        private bool _UseLimitSwichXmin = true;
        /// <summary>
        /// Использование концевика
        /// </summary>
        [DisplayName(@"X-")]
        ...
        [Category("2.2 Использование концевиков")]
        [TypeConverter(typeof(BooleanTypeConverter))]
        public bool UseLimitSwichXmin
        {
            get { return _UseLimitSwichXmin; }
            set { _UseLimitSwichXmin = value; }
        }
        ...
        /// Использование концевика
        /// </summary>
        private bool _UseLimitSwichYmax = true;
        /// <summary>
        /// Использование концевика
        /// </summary>
        [DisplayName(@"Y+")]
        ...
        [Category("2.2 Использование концевиков")]
        [TypeConverter(typeof(BooleanTypeConverter))]
        public bool UseLimitSwichYmax
        {
            get { return _UseLimitSwichYmax; }
            set { _UseLimitSwichYmax = value; }
        }
        ...
        /// Использование концевика
        /// </summary>
        private bool _UseLimitSwichYmin = true;
        /// <summary>
        /// Использование концевика
        /// </summary>
        [DisplayName(@"Y-")]
        ...
        [Category("2.2 Использование концевиков")]
        [TypeConverter(typeof(BooleanTypeConverter))]
        public bool UseLimitSwichYmin
        {
            get { return _UseLimitSwichYmin; }
            set { _UseLimitSwichYmin = value; }
        }
        ...
        /// Использование концевика
        /// </summary>
        private bool _UseLimitSwichZmax = true;
        /// <summary>
        /// Использование концевика
        /// </summary>
        [DisplayName(@"Z+")]
        ...
        [Category("2.2 Использование концевиков")]
        [TypeConverter(typeof(BooleanTypeConverter))]
        public bool UseLimitSwichZmax
        {
            get { return _UseLimitSwichZmax; }
            set { _UseLimitSwichZmax = value; }
        }
        ...
        /// Использование концевика
        /// </summary>
        private bool _useLimitSwichZmin = true;
        /// <summary>
        /// Использование концевика
        /// </summary>
        [DisplayName(@"Z-")]
        ...
        [Category("2.2 Использование концевиков")]
        [TypeConverter(typeof(BooleanTypeConverter))]
        public bool UseLimitSwichZmin
        {
            get { return _useLimitSwichZmin; }
            set { _useLimitSwichZmin = value; }
        }
    ...
    public class AxleSetting
    {
        ...
        /// Конструктор
        /// </summary>
        public AxleSetting(bool usedAxes = true, int countPulse = 200, string nameUe = "мм.", int maxSpeed = 200, int acceleration = 20, bool reversAxle = false, bool reversSignal = false)
        {
            _usedAxes = usedAxes;
            ...
            _reversAxle = reversAxle;
            _reversSignal = reversSignal;
        }
        ...
        private bool _reversAxle;
        [DisplayName(@"Реверс оси")]
        [Description("Изменение вращения оси, в обратную сторону")]
        [PropertyOrder(10)]
        [TypeConverter(typeof(BooleanTypeConverter))]
        public bool reversAxle
        {
            get { return _reversAxle; }
            set { _reversAxle = value; }

        }

        private bool _reversSignal;
        [DisplayName(@"Реверс сигнала step")]
        [Description("Инвертирование сигнала step")]
        [PropertyOrder(10)]
        [TypeConverter(typeof(BooleanTypeConverter))]
        public bool reversSignal
        {
            get { return _reversSignal; }
            set { _reversSignal = value; }
