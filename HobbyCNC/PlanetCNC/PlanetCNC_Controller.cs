namespace CNC_Assist.PlanetCNC
{
    static class PlanetCNC_Controller
    {
        ...
        {
            Controller.AddBinaryDataToTask(BinaryData.pack_B5(true, 2, BinaryData.TypeSignal.Hz, PlanetCNC_Controller.ValueHz),true);
        ...
        {
            Controller.AddBinaryDataToTask(BinaryData.pack_B5(false, 2, BinaryData.TypeSignal.Hz, PlanetCNC_Controller.ValueHz),true);
            //зафиксируем
