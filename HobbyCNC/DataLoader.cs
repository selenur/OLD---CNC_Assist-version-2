...
namespace CNC_Assist
{
    ...
    static class DataLoader
    {
        ...
        /// <summary>
        /// Переменная хранит начальную выделенную строку из списка G-кода
        /// </summary>
        public static int SelectedRowStart = -1;
        /// <summary>
        /// Переменная хранит конечную выделенную строку из списка G-кода
        /// </summary>
        ...
        public static ResultCommand ReadFromBuffer(bool needAskClearData = true)
        {
    ...
    class ToolOptions
    {
        ...
        public ToolOptions(bool _NeedChange, int _NumberTools, float _DiametrTools)
        {
