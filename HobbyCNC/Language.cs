    ...
    static class Language
    {
        ...
        public static void Init()
        {
            ...
            ValueLangStrings.Add(new langString(@"_menulanguage_"               , @"Выбор языка"                , @"Select language")); 
                ...
                ValueLangStrings.Add(new langString(@"_WigetLimit_", @"Концевики", @"Sensor limits"));

                ValueLangStrings.Add(new langString(@"_LimitXmin_", @"       Xмин", @"       Xmin"));
                ValueLangStrings.Add(new langString(@"_LimitYmin_", @"       Yмин", @"       Ymin"));
                ValueLangStrings.Add(new langString(@"_LimitZmin_", @"       Zмин", @"       Zmin"));
                ValueLangStrings.Add(new langString(@"_LimitXmax_", @"       Xмакс", @"       Xmax"));
                ValueLangStrings.Add(new langString(@"_LimitYmax_", @"       Yмакс", @"       Ymax"));
                ValueLangStrings.Add(new langString(@"_LimitZmax_", @"       Zмакс", @"       Zmax"));         
